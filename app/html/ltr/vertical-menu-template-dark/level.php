                ...
                <div class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto;">
                    <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                        ...
                        <div class="swal2-content">
                            <div id="swal2-content" style="display: block;"><?php echo $level_name . ' have not been added, verify the the encoding'; ?></div>
...
if (isset($_POST['delete_level'])) {
    if ($role == "admin" or $role == "headmaster") {
        $delete_level_id = $_POST['delete_level'];
        $result = $user->delete_level($delete_level_id, $matricule_etablissement, $date_academique);
        switch ($result) {
            case 0: ?>
                <div class="swal2-container swal2-center swal2-fade swal2-shown" style="overflow-y: auto;">
                    <div aria-labelledby="swal2-title" aria-describedby="swal2-content" class="swal2-popup swal2-modal swal2-show" tabindex="-1" role="dialog" aria-live="assertive" aria-modal="true" style="display: flex;">
                        ...
                        <div class="swal2-content">
                            <div id="swal2-content" style="display: block;"><?php echo 'The level have not been deleted.. try after few minutes'; ?></div>
                            <input class="swal2-input" style="display: none;">
                            <input type="file" class="swal2-file" style="display: none;">
                            <div class="swal2-range" style="display: none;">
                                <input type="range"><output></output>
